...
compatibility: Designed for Claude Code or any Agent Skills-compatible agent. Operates on the SalesWiki Obsidian Markdown vault; needs Python 3 for scripts/health_check.py and scripts/build_indexes.py.
metadata:
  author: SalesWiki
  version: "1.0"
---
