...
compatibility: Designed for Claude Code or any Agent Skills-compatible agent. Operates on the SalesWiki Obsidian vault; reads the scoring process docs under wiki/processes/.
metadata:
  author: SalesWiki
  version: "1.0"
---
