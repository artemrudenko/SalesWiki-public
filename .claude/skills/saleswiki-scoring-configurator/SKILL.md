...
compatibility: Designed for Claude Code or any Agent Skills-compatible agent. Operates on schemas/scoring-models.json, scoring process docs and state/scoring-change-requests.md.
metadata:
  author: SalesWiki
  version: "1.0"
---
