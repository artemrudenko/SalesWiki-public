...
class PipelineRiskDigest(unittest.TestCase):
    ...
    def test_hos_sees_all_deal_risk(self) -> None:
        out = self.svc.pipeline_risk_digest(actor("demo-elena-hos"))
    ...
    def test_owner_sees_only_own_deals(self) -> None:
        out = self.svc.pipeline_risk_digest(actor("demo-ivan-ae"))
    ...
    def test_marketing_gets_aggregate_no_named_deals(self) -> None:
        out = self.svc.pipeline_risk_digest(actor("demo-nina-marketing"))
    ...
    def test_digest_reports_pending_proposals(self) -> None:
        self.svc.flag_stale_or_wrong(actor("demo-ivan-ae"), "demo-company-bluepeak-energy", "stale pricing")
        out = self.svc.pipeline_risk_digest(actor("demo-elena-hos"))
    ...
    def test_audit_records_pipeline_digest(self) -> None:
        self.svc.pipeline_risk_digest(actor("demo-elena-hos"))
    ...
    def test_owner_rollup_scoped_to_visible_deals(self) -> None:
        out = self.svc.pipeline_risk_digest(actor("demo-ivan-ae"))
        t = out["text"]
        # Ivan sees five sales-west deals, including the dense graph fixture.
    ...
    def test_digest_renders_single_conclusion_and_footer(self) -> None:
        ...
        t = self.svc.pipeline_risk_digest(actor("demo-elena-hos"))["text"]
